  ...
  return (
    <section className="relative overflow-hidden bg-[color:var(--color-forest)] text-[color:var(--color-cream)]">
      <div ref={ref} className="reveal relative mx-auto max-w-3xl px-5 py-16 text-center sm:px-6 sm:py-24 lg:px-10">
        ...
        <h2 className="mt-5 font-serif text-3xl font-semibold text-[color:var(--color-cream)] sm:text-4xl md:text-5xl">
          {t("closing.title")}
        </h2>
        <p className="mx-auto mt-5 max-w-xl text-base font-semibold leading-relaxed text-[color:var(--color-cream)]/85">
          {t("closing.body")}
        </p>
        <Link
          to="/programmes"
